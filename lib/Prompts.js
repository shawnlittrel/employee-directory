          ...
          <div class="column is-2 is-offset-1">
            <div class="card">
              ...
              <div class="card-content">
                ...
                <div class="content has-text-centered">Email: <a href="mailto:${email}">${email}</a></div>
              </div>
        ...
        for(var i = 0 ; i < arr.length; i++){
            ...
            <div class="card">
                ...
                <div class="card-content has-text-centered">
                    ...
                    <div class="content">Email: <a href="mailto:${email}">${email}</a></div>
                    <div class="content">Github: <a href="https://www.github.com/${github}" target="_blank" rel="noopener noreferrer">${github}</a></div>
                </div>
            </div>
        </div>
            `
